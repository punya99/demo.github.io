...
! function(e) {
    ...
    var e, n, d, s, r, p, h, f, g, m, y, i, o, v, a = ((u = t && t.fn && t.fn.select2 && t.fn.select2.amd ? t.fn.select2.amd : u) && u.requirejs || (u ? n = u : u = {}, f = {}, g = {}, m = {}, y = {}, i = Object.prototype.hasOwnProperty, o = [].slice, v = /\.js$/, p = function(e, t) {
            ...
            return t.Extend(n, e), n.prototype.current = function(e) {
                ...
                this.$element.prop("multiple") ? this.current(function(e) {
                    ...
                    for (var n = 0; n < o.length; n++) {
                        var i = o[n].id; - 1 === r.inArray(i, t) && t.push(i)
                    }
            ...
            return c.Extend(i, e), i.prototype.select = function(n) {
                ...
                })).length && (e = this.option(n), this.addOptions(e)), i.__super__.select.call(this, n)
                ...
                for (var s = 0; s < e.length; s++) {
                    ...
                    0 <= u.inArray(l.id, i) ? (a = n.filter(function(e) {
                        return function() {
                            return u(this).val() == e.id
                        }
                    }(l)), r = this.item(a), r = u.extend(!0, {}, l, r), r = this.option(r), a.replaceWith(r)) : (a = this.option(l), l.children && (l = this.convertToOptions(l.children), c.appendMany(a, l)), o.push(a))
                }
                return o
            }, i
            ...
            return t.Extend(n, e), n.prototype._applyDefaults = function(e) {
                ...
                function e() {
                    var e = o.transport(o, function(e) {
                        ...
                        i.options.get("debug") && window.console && console.error && (e && e.results && s.isArray(e.results) || console.error("Select2: The AJAX results did not return an array in the `results` key of the response.")), n(e)
                    }, function() {
            ...
            return e.prototype.bind = function(e, t, n) {
                ...
                for (var o = n.get("tokenSeparators") || [], s = t.term, r = 0, a = this.createTag || function(e) {
                    ...
                    var l = s[r]; - 1 !== c.inArray(l, o) ? (l = s.substr(0, r), null != (l = a(c.extend({}, t, {
                        term: l
            ...
            return t.prototype.render = function(e) {
                var t = e.call(this),
                    e = o('<span class="select2-search select2-search--dropdown"><input class="select2-search__field" type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false" role="textbox" /></span>');
            ...
            function e(e, t) {
                this.options = e, null != t && this.fromElement(t), this.options = i.apply(this.options), t && t.is("input") && (t = n(this.get("amdBase") + "compat/inputData"), this.options.dataAdapter = r.Decorate(this.options.dataAdapter, t))
            }
            ...
            return {
                syncCssClasses: function(e, t, n) {
                    ...
                    s && r((s = "" + s).split(/\s+/)).each(function() {
                        0 === this.indexOf("select2-") && o.push(this)
                    }), (s = r.trim(t.attr("class"))) && r((s = "" + s).split(/\s+/)).each(function() {
            ...
            return e.prototype.render = function(e) {
                ...
                o = o || a, -1 !== n.indexOf(":all:") && (n = n.replace(":all:", ""), i = o, o = function(e) {
                    var t = i(e);
                    return null != t ? t + " " + e : e
                });
        ...
        }, "function" == typeof u.define && u.define.amd ? u.define("jquery-mousewheel", ["jquery"], a) : "object" == typeof exports ? module.exports = a : a(t), u.define("jquery.select2", ["jquery", "jquery-mousewheel", "./select2/core", "./select2/defaults"], function(o, e, s, t) {
            var r;
            return null == o.fn.select2 && (r = ["open", "close", "destroy"], o.fn.select2 = function(t) {
    ...
    function l(e, t) {
        var n, i, o, s, r, a, l, c, u, d, p = t && t.split("/"),
            h = m.map,
            f = h && h["*"] || {};
        if (e && "." === e.charAt(0))
            if (t) {
