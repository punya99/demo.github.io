...
function initEvents() {
    ...
    jQuery('.swipebox.image-video').magnificPopup({
        type: 'iframe'
    });
    ...
    */
    jQuery('.ltx-arrow-down').on('click', function() {
        ...
        jQuery("html, body").animate({
            scrollTop: jQuery(next).offset().top - 100
        }, 500);
    });
    ...
    jQuery(ltxSliders).each(function(i, el) {
        ...
        jQuery(breakpoints_per).each(function(i, el) {
            ...
            if (el) {
                ...
                if (container.data('slides-per-group')) spg = el;
                else spg = 1;
                spg = 1;
                breakpoints[breakpoints_viewports[i]] = {
                    slidesPerView: el,
                    slidesPerGroup: spg
                };
