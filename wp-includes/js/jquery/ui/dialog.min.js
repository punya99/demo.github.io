    ...
    return l.widget("ui.dialog", {
        ...
        _createWrapper: function() {
            this.uiDialog = l("<div>").hide().attr({
                ...
                keydown: function(i) {
                    if (this.options.closeOnEscape && !i.isDefaultPrevented() && i.keyCode && i.keyCode === l.ui.keyCode.ESCAPE) return i.preventDefault(), void this.close(i);
                    var t, e, o;
                    i.keyCode !== l.ui.keyCode.TAB || i.isDefaultPrevented() || (t = this.uiDialog.find(":tabbable"), e = t.first(), o = t.last(), i.target !== o[0] && i.target !== this.uiDialog[0] || i.shiftKey ? i.target !== e[0] && i.target !== this.uiDialog[0] || !i.shiftKey || (this._delay(function() {
                        o.trigger("focus")
        ...
        _createOverlay: function() {
            ...
            this.options.modal && (e = l.fn.jquery.substring(0, 4), o = !0, this._delay(function() {
                ...
                var t;
                o || ((t = this._trackingInstances()[0])._allowInteraction(i) || (i.preventDefault(), t._focusTabbable(), "3.4." !== e && "3.5." !== e || t._delay(t._restoreTabbableFocus)))
