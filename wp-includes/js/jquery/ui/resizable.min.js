...
! function(t) {
    ...
    return z.widget("ui.resizable", z.ui.mouse, {
        ...
        _updateVirtualBoundaries: function(t) {
            ...
            (this._aspectRatio || t) && (t = h.minHeight * this.aspectRatio, e = h.minWidth / this.aspectRatio, i = h.maxHeight * this.aspectRatio, s = h.maxWidth / this.aspectRatio, t > h.minWidth && (h.minWidth = t), e > h.minHeight && (h.minHeight = e), i < h.maxWidth && (h.maxWidth = i), s < h.maxHeight && (h.maxHeight = s)), this._vBoundaries = h
        },
